...
CREATE TABLE `servicerecords` (
  ...
  CONSTRAINT `servicerecords_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`)
...
INSERT INTO `servicerecords` VALUES (1,1,'2024-04-29','Principal','2024-04-30','Teacher','2024-05-01','PArt Time');
